...
static void do_init(void) {
  ...
  charging_layer = my_create_layer(GRect(0, 0, frame.size.w - 2, 26), FONT_KEY_GOTHIC_18, 
                                   GTextAlignmentCenter, GColorWhite, GColorClear);
  hour_layer = my_create_layer(GRect(0, 0, frame.size.w, 50), FONT_KEY_BITHAM_42_BOLD, 
  ...
  minute_two_layer = my_create_layer(GRect(0, 75, frame.size.w, 50), FONT_KEY_BITHAM_42_LIGHT, 
                                     GAlignLeft, GColorWhite, GColorClear);
  battery_layer = my_create_layer(GRect(0, 20, frame.size.w - 2, 26), FONT_KEY_GOTHIC_18, 
                                  GTextAlignmentRight, GColorWhite, GColorClear);
  date_layer = my_create_layer(GRect(0, 20, frame.size.w - 2, 26), FONT_KEY_GOTHIC_18, 
                               GTextAlignmentLeft, GColorWhite, GColorClear);
